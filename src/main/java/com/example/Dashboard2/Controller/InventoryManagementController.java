...
public class InventoryManagementController {
    ...
    @GetMapping("/getIncomingLive")
    public List<InventoryManagement> getIncomingLive(@RequestParam int vendorId) {
        return inventoryManagementService.getIncomingLive(vendorId);
    }

    @GetMapping("/getIncomingLiveWithMissing")
    public List<IncomingLiveWithMissingDTO> getIncomingLiveWithMissing(@RequestParam int vendorId) {
        return inventoryManagementService.getIncomingLiveWithMissing(vendorId);
    }

    @GetMapping("/getIncomingClosed")
    public List<InventoryManagement> getIncomingClosed(@RequestParam int vendorId) {
        return inventoryManagementService.getIncomingClosed(vendorId);
    }
