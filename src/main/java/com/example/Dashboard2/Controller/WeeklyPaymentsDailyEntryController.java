...
public class WeeklyPaymentsDailyEntryController {
    ...
    @PutMapping("/{id}/remove-file")
    public ResponseEntity<WeeklyPaymentsDailyEntry> removeFile(
            @PathVariable Long id,
            @RequestBody String user) {
        return ResponseEntity.ok(service.removeFileUrl(id, user));
    }

    @PutMapping("/{id}/restore-file")
    public ResponseEntity<WeeklyPaymentsDailyEntry> restoreFile(@PathVariable Long id) {
        return ResponseEntity.ok(service.restoreFileUrl(id));
    }
