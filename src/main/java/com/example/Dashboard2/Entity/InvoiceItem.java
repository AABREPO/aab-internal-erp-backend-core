...
public class InvoiceItem {
    ...
    public String getSizeInput() { return sizeInput; }
    public void setSizeInput(String sizeInput) { this.sizeInput = sizeInput; }
    ...
    public boolean isMainRow() { return isMainRow; }
    public void setMainRow(boolean mainRow) { isMainRow = mainRow; }
