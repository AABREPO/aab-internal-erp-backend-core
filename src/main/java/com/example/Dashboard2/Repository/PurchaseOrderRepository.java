...
public interface PurchaseOrderRepository extends JpaRepository<PurchaseOrder, Long> {
    ...
    List<PurchaseOrder> findByVendorIdAndDeleteStatusFalseOrderByIdDesc(int vendorId);
...
""")
    ...
    // Get all purchase orders by siteInchargeId (excluding deleted)
    List<PurchaseOrder> findBySiteInchargeIdAndDeleteStatusFalseOrderByIdDesc(int siteInchargeId);
    List<PurchaseOrder> findByIsGrnRequestSendTrueAndDeleteStatusFalseOrderByIdDesc();
}